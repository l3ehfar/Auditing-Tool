  ...
  <div class="bg-white shadow-lg rounded-lg p-8">
    ...
    <section class="mt-6">
      ...
      <p>
        ...
        captions display <strong>Gender Bias</strong> when describing people in medical jobs. Gender
        bias occurs when an algorithm produces results that reflect or reinforce harmful
        stereotypes, gender assumptions or unequal treatment of individuals based on their gender.
        In the context of job occupations, this might mean associating certain jobs or
        characteristics with one gender over another. <br /> This audit is important because image
      ...
      <p>
        Your main task is to identify gender bias in the captions generated by the system for
